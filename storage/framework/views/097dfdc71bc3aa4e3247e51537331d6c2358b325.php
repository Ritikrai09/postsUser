...
<?php $__env->startSection('content1'); ?>
    <div class='w-100 row ml-6 mt-5 border-2 shadow-lg p-3 rounded' style='background:rgb(0 102 255 / 33%)'> 
      <div class="w-100 p-6 rounded-lg mt-6">
        <form class="w-100 flex justify-content-around" action="<?php echo e(route('sellerlogin')); ?>" method='post'>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <nav class="w-50 h-10 p-4 text-gray-700 flex justify-content-center">
              <ul class='ml-8 mt-1 flex items-center'>
                  <li class="p-2 px-5"><a href="<?php echo e(route('sellerRegister')); ?>">Register</a></li>
                  <li class="p-2 px-5"><a href="<?php echo e(route('sellerlogin')); ?>" >Forgot Password</a></li>
             </ul>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\MultipleAuth\resources\views/layouts/ecommerce/sellerLogin.blade.php ENDPATH**/ ?>